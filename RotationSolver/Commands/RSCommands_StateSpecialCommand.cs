...
namespace RotationSolver.Commands
{
    public static partial class RSCommands
    {
        ...
        private static string _aoeString => "AOE " + (Basic.Configuration.PluginConfiguration.GetValue(SettingsCommand.UseAOEAction) && (DataCenter.StateType != StateCommandType.Manual || Basic.Configuration.PluginConfiguration.GetValue(SettingsCommand.UseAOEWhenManual)) ? "on" : "off");

        private static string _preventString => "Prevent " + (Basic.Configuration.PluginConfiguration.GetValue(SettingsCommand.PreventActions) ? "on" : "off");
