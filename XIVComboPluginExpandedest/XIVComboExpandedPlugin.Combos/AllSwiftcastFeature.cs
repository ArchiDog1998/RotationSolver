...
internal class AllSwiftcastFeature : CustomCombo
{
	...
	{
		if ((actionID == 125 || actionID == 173 || actionID == 3603 || actionID == 7523 || actionID == 24287) && ((CustomCombo.GetCooldown(7561u).CooldownRemaining == 0f && !CustomCombo.HasEffect(1249)) || level <= 12 || (level <= 64 && actionID == 7523)))
		{
			return 7561u;
		}
		return actionID;
