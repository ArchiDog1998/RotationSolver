...
public abstract partial class CustomCombo<TCmd> where TCmd : Enum
{
    ...
    /// <returns></returns>
    protected abstract bool AttackAbility(byte abilityRemain, out IAction act);
    /// <summary>
    ...
    /// <param name="act"></param>
    /// <returns></returns>
    protected virtual bool EmergercyAbility(byte abilityRemain, IAction nextGCD, out IAction act)
    {
    ...
    /// <param name="act"></param>
    /// <returns></returns>
    protected virtual bool GeneralAbility(byte abilityRemain, out IAction act)
    {
        act = null; return false;
    }

    protected virtual bool MoveAbility(byte abilityRemain, out IAction act)
    {
        act = null; return false;
    }
    ...
    /// <param name="act"></param>
    /// <returns></returns>
    protected virtual bool HealSingleAbility(byte abilityRemain, out IAction act)
    {
        act = null; return false;
    }

    protected virtual bool DefenceSingleAbility(byte abilityRemain, out IAction act)
    {
        act = null; return false;
    }
    protected virtual bool DefenceAreaAbility(byte abilityRemain, out IAction act)
    {
        act = null; return false;
    }
    /// <summary>
    ...
    /// <param name="act"></param>
    /// <returns></returns>
    protected virtual bool HealAreaAbility(byte abilityRemain, out IAction act)
    {
        act = null; return false;
    }
}
