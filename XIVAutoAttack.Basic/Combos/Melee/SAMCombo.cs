...
public abstract class SAMCombo<TCmd> : JobGaugeCombo<SAMGauge, TCmd> where TCmd : Enum
{
    ...
    protected static bool HaveMoon => Player.HaveStatus(ObjectStatus.Moon);
    protected static bool HaveFlower => Player.HaveStatus(ObjectStatus.Flower);
