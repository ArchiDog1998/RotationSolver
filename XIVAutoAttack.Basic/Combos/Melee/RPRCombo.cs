...
public abstract class RPRCombo<TCmd> : JobGaugeCombo<RPRGauge, TCmd> where TCmd : Enum
{
    ...
    protected static bool enshrouded => Player.HaveStatus(ObjectStatus.Enshrouded);
    protected static bool soulReaver => Player.HaveStatus(ObjectStatus.SoulReaver);
    protected static bool enhancedGibbet => Player.HaveStatus(ObjectStatus.EnhancedGibbet);
    protected static bool enhancedGallows => Player.HaveStatus(ObjectStatus.EnhancedGallows);
    protected static bool enhancedCrossReaping => Player.HaveStatus(ObjectStatus.EnhancedCrossReaping);
    protected static bool enhancedVoidReaping => Player.HaveStatus(ObjectStatus.EnhancedVoidReaping);
    protected static bool plentifulReady => Player.HaveStatus(ObjectStatus.ImmortalSacrifice) && !Player.HaveStatus(ObjectStatus.BloodsownCircle);
    protected static bool haveDeathsDesign => Target.HaveStatus(ObjectStatus.DeathsDesign);
