...
public abstract class WARCombo<TCmd> : JobGaugeCombo<WARGauge, TCmd> where TCmd : Enum
{

    public sealed override uint[] JobIDs => new uint[] { 21, 3 };
    public sealed override bool HaveShield => Player.HaveStatus(ObjectStatus.Defiance);
