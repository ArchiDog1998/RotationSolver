...
public abstract class PLDCombo<TCmd> : JobGaugeCombo<PLDGauge, TCmd> where TCmd : Enum
{

    public sealed override uint[] JobIDs => new uint[] { 19, 1 };

    public sealed override bool HaveShield => Player.HaveStatus(ObjectStatus.IronWill);
