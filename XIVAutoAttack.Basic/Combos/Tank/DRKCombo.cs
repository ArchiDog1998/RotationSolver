...
public abstract class DRKCombo<TCmd> : JobGaugeCombo<DRKGauge, TCmd> where TCmd : Enum
{ 
    public sealed override uint[] JobIDs => new uint[] { 32 };
    public sealed override bool HaveShield => Player.HaveStatus(ObjectStatus.Grit);
