...
public abstract class GNBCombo<TCmd> : JobGaugeCombo<GNBGauge, TCmd> where TCmd : Enum
{
    public sealed override uint[] JobIDs => new uint[] { 37 };
    public sealed override bool HaveShield => Player.HaveStatus(ObjectStatus.RoyalGuard);
