...
{
    public abstract partial class BLMCombo<TCmd> : JobGaugeCombo<BLMGauge, TCmd> where TCmd : Enum
    {
        public sealed override uint[] JobIDs => new uint[] { 25, 7 };

        protected static bool HasFire => Player.HaveStatus(ObjectStatus.Firestarter);
        protected static bool HasThunder => Player.HaveStatus(ObjectStatus.Thundercloud);
