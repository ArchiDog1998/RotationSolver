...
//            {
//                OtherCheck = () => TargetHelper.PartyMembersHP.Min() < 0.15,
//            },
...
//        //救疗
//        if (Actions.Cure2.TryUseAction(level, out act, lastComboActionID)) return true;
...
//        //天赐救人啊！
//        if (Actions.Benediction.TryUseAction(level, out act)) return true;
...
//        //单体输出
//        if (Actions.Aero.TryUseAction(level, out act, mustUse: IsMoving && HaveTargetAngle)) return true;
